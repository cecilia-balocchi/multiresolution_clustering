...
paralleltemp_noLR <- function(Y, Mapping, InvMapping, n, n2, burnin, adjust = 0, save, gibbs, 
                     nchains, temps,
                     print_bool = FALSE,  
                     one_vs_manyLR_bool = TRUE, one_vs_manyHR_bool = TRUE,
                     eta_LR = 1, eta_CT = 1, eta_TD = 1, 
                     kH = 0.1, alphaH = 1, betaH = 1, seed = NULL, 
  ...
  out <- .C("mainfunc", Y_input = as.double(Y), YLR_input = integer(1),
            ...
            k_L_ptr = as.double(0.1), alpha_L_ptr = as.double(1), beta_L_ptr = as.double(1), 
            alpha1_ptr = as.double(alpha1), alpha2_ptr = as.double(integer(1)),

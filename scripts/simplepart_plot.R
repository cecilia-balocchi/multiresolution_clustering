...
### To replicate the plots in the paper, we should run this for nct = 10, 25, and 50, uncommenting the following lines.
n_ct = 10
# n_ct = 25
# n_ct = 50
...
m <- 10
resultsHR <- get(paste0("resultsHR_m",m,"_d",d,"sim"))
resultsLR <- get(paste0("resultsLR_m",m,"_d",d,"sim"))
...
png(paste0("figures/boxplots_paper_simplepart3_nct",n_ct,"_",d,"_text2.png"), width = 8, height = 4, units = "in", res = 200)
